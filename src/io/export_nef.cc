...
void export_nefdbg(std::shared_ptr<Geometry const> const & geom, std::ostream& output)
{
...
void export_nef3(std::shared_ptr<Geometry const> const& geom, std::ostream& output)
{
  if (auto N = CGALUtils::getNefPolyhedronFromGeometry(geom)) {
