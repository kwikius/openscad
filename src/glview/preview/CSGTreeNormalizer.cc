...
std::shared_ptr<CSGNode> CSGTreeNormalizer::normalizePass(std::shared_ptr<CSGNode> node)
{
  ...
  typedef std::pair<std::shared_ptr<CSGOperation>, bool> stackframe_t;
